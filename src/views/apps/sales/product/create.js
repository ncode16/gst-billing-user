...
import { addProduct } from '../../../../api/addProductManagement/index'
                ...
                <div className='details-tab-main-div'>
                  ...
                  <div className='add-product-form-main-div'>
                    ...
                    <div className='item-input-div'>
                      <span className='text-danger'>*</span><span className='text-dark more-detail-font'>Item Name</span>
                      <InputGroup>
                        <Form.Control
                          type='text'
                          name='item_name'
                    ...
                    <div className='selling-price-div'>
                      <Row>
                        <Col md='6' className='selling-price-col-1'>
                          <span className='text-dark selling-price-label more-detail-font'>Selling Price</span>
                          <InputGroup>
                            <Form.Control
                              type='number'
                              name='sell_price'
                    ...
                    <div className='primary-unit-main-div'>
                      <Row>
                        <Col md='6' className='primary-unit-col-1'>
                          <span className='text-dark primary-unit-label more-detail-font'>Primary Unit</span>
                  ...
                  <div className='additional-information-main-div'>
                    <div className='opening-quantity-div'>
                      <Row>
                        <Col md='6' className='additional-information-col-1'>
                          <span className='text-dark hsn-code-label-span more-detail-font'>HSN/SAC Code</span>
                          <span className='hsn-field'>
                        ...
                        <Col md='6' className='additional-information-col-2'>
                          <span className='text-dark purchase-price-label-span more-detail-font'>Purchase Price</span>
                    ...
                    <div className='barcode-category-main-div'>
                      <Row>
                        <Col md='6' className='barcode-category-col-1'>
                          <span className='text-dark barcode-label-span more-detail-font'>Barcode</span>
                          <span className='hsn-field'>
                            <InputGroup className='hsn-input-field'>
                              <Form.Control
                                type='text'
                        ...
                        <Col md='6' className='barcode-category-col-2'>
                          <span className='text-dark category-label-span more-detail-font'>Category</span>
                    ...
                    <div className='product-image-main-div'>
                      <span className='text-dark product-image-label-span more-detail-font'>Product Image</span>
                    ...
                    <div className='rich-editor-main-div'>
                      ...
                      <span className='text-dark description-heading-span more-detail-font'>Description</span>
                    ...
                    <div className='opening-quantity-div'>
                      <Row>
                        <Col md='6' className='opening-quantity-col-1'>
                          <span className='text-dark opening-quantity-label-span more-detail-font'>Opening Quantity</span>
                          <InputGroup>
                            <Form.Control
                              type='number'
                        ...
                        <Col md='6' className='opening-perchase-col-2'>
                          <span className='text-dark opening-perchase-label-span more-detail-font'>Opening Purchase Price (with tax)</span>
                          <InputGroup>
                            <Form.Control
                              type='number'
                    ...
                    <div className='opening-stock-div'>
                      <Row>
                        <Col md='6' className='opening-stock-col-1'>
                          <span className='text-dark opening-stock-label-span more-detail-font'>Opening Stock Value (with tax)</span>
                          <InputGroup>
                            <Form.Control
                              type='number'
                      ...
                      <Panel header={<div className='tags-text'><span>More Details?</span><p>Cess, Discount, Show Online, Inventory tracking, Low stock alerts etc.</p></div>} key="1">
                        <div className='discount-section'>
                          <Row>
                            <Col md='6'>
                              <div className='discount-fild'>
                                <label className='more-detail-font'>Discount(%)</label>
                                <InputGroup>
                                  <Form.Control
                                    addonAfter='%'
                            ...
                            <Col md='6'>
                              <div className='discount-fild'>
                                <label className='more-detail-font'>Discount Amount</label>
                                <InputGroup>
                                  <Form.Control
                                    addonAfter='₹'
                                    className='discount-percent-input'
                          ...
                          <div className='show-discount-main-div'>
                            <span className='more-detail-font'><b>Show Discount in</b></span>
                            <Radio.Group>
                          ...
                          <div className='low-stock-main-div'>
                            <Row>
                              <Col md='6' className='low-stock-col-1'>
                                <span className='more-detail-font'><b>Cess</b></span>
                                <InputGroup>
                                  <Form.Control
                                    type='number'
                              ...
                              <Col md='6' className='low-stock-col-1'>
                                <span className='more-detail-font'><b>Low Stock Alert at</b></span>
                                <InputGroup>
                                  <Form.Control
                                    type='number'
                                    className='low-stock-text-input'
                          ...
                          <div className='not-for-sale-main-div'>
                            <Row>
                              <Col md='6' className='low-stock-col-2'>
                                <span className='more-detail-font'><b>Show in Online Store</b></span>
