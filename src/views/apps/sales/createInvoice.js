...
import { AddNewInvoiceData } from "../../../api/addInvoiceManagement/index";
<link
  rel="stylesheet"
...
const Index = () => {
  ...
  const addInvoiceDataHandler = (invoiceInfo) => {
    const decoded = localStorage.getItem("userDetails");
    const token = jwtDecode(decoded);
    const modifiedInvoiceInfo = {
      ...invoiceInfo,
      user_id: token?.user_id,
      customer_id: getCustomerData[0]?.customer_id,
      product_id: getProductList[0]?.product_id,
      bank_id: bankList[0]?.bank_id,
      signature_id: signatureList[0]?.signature_id,
      document_id: settingDetail?.document_id,
    };
    const newInvoiceResponse = AddNewInvoiceData(modifiedInvoiceInfo);
    newInvoiceResponse
      .then((response) => {
    ...
    <div className="card">
      <Form>
        <div className="card-sub-div">
          ...
          >
            <h3
              ...
              onClick={() => navigate("/apps/sales/list")}
            >
              <ChevronLeft />
              {documentTitle ? "Create Bill of Supply" : "Create Invoice"}
            </h3>
            <div className="inv-text">
              <span>
                <Input
                  type="text"
                  value={`${settingDetail?.invoice_prefix}`}
                  className="inv-text"
                />
              </span>
              <span>
                ...
                {documentTitle ? (
                  <div className="invoice-picker-text">
                    ...
                    <DatePicker
                      ...
                      name="bill_of_supply_date"
                      {...register("bill_of_supply_date")}
                    />
                  </div>
                ) : (
                  <div className="invoice-picker-text">
            ...
            <Row>
              ...
              <Col className="bill-btn-col">
                <div className="add-bill-btn">
                  <Button type="button" color="primary" className="bill-button">
                    <Plus size={15} />
            ...
            <div>
              {documentTitle ? (
                <Table responsive className="table-main">
                  <thead>
                    <tr>
                      <th className="product-table-head">Product Name1</th>
                    ...
                    <tr>
                      <td className="first-td-main">
                        ...
                        <td className="first-first-sub-td">
                          Avl. qty:-1100
                          <span className="first-first-td-span">HSN/SAC:</span>
                          <td className="first-second-sub-td">
                            0000000{" "}
                      ...
                      <td className="second-td-main">
                        <span className="second--hide-td-plus-a-tag">
                          ...
                          <span className="second-hide-td-desc-span">Desc</span>
                        </span>
                      </td>
                      <td className="third-td-main">
                        <span className="third-td-main-span">
                          {" "}
                          <InputNumber className="third-td-input-num" />
                          <span className="third-td-oth-span">OTH</span>
                        </span>
                      </td>
                      ...
                      <td className="fifth-td-main">
                        <span className="fifth-td-main-span">
                          {" "}
                          <InputNumber className="fifth-td-input-num" />
                ...
                <Table responsive className="table-main">
                  <thead>
                    <tr>
                      ...
                      <th className="product-table-head">
                        <span className="invoice-heading-net-amount-main-span">
                          <span className="invoice-heading-net-amount-first-span">
                            Net Amount
                          </span>
                          <span className="invoice-heading-net-amount-second-span">
                            Tax (%) + Cess (%)
                          </span>
                        </span>
                      </th>
                  ...
                  <tbody className="product-table-body">
                    <tr>
                      ...
                      <td className="sixth-td-main">
                        <span className="tax-cess-main-span">
                          <span className="sixth-td-first-span">
                            1100.00
                            <span className="tax-cess-span">0.00(0%)</span>
                          </span>
                        </span>
                      </td>
                      <td className="sixth-td-main">
                    ...
                    <Col md="12" className="total-amount-col-2">
                      <span>
                        ...
                        <span className="round-off-switch-span">
                          <Switch onChange={showRoundOff} size="small" />
                        </span>
                      </span>
                      {roundOff ? (
                        <span className="round-off-span">API Value</span>
                      ) : (
                ...
                <div className="add-sign-to-invoice-btn-div">
                  {signatureList?.length > 0 ? (
                    <Select
                      ...
                      // onClick={(value) => setValue("signature_id", value)}
        ...
        <div className="save-btn-main-div">
          <button type="button" className="save-print-btn">
            Save and Print
          </button>
          <button
            type="button"
            className="save-btn"
            onClick={handleSubmit(addInvoiceDataHandler)}
          >
            Save
