...
const CreatePurchase = () => {
    ...
    const backToList = () => {
        navigate('/apps/purchase-order/list')
    }
    ...
    return (
        <div className='card card-box'>
            <div className='purchase-top-title'>
                <h3 className='create-purchase-header'><ChevronLeft onClick={() => backToList()} />Create Purchase Order
                </h3>
                <div className='pinv-text'>
                    <span><Input type="text" value="PO-" className='pinv-text' /></span>
