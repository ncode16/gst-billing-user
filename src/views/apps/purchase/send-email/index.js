        ...
        >
            <div>
                <Form>
                    ...
                    <div className='basic-details-header email-body-header'>
                        ...
                        <div className='basic-details-card-body'>
                            <div>
                                ...
                                <div className='email-template-text'>
                                    <span style={{ fontSize: '12px' }} className='only-web'>(Only available on web)</span>
                                ...
                                <div className='field-down email-body-label'>
                                    <Label className='basic-details-label email-body'>Email Body:</Label>
                                    <ReactQuill style={{ height: '15%' }} placeholder='Email Text' />
                                </div>
                                <div className='field-down email-footer-label'>
                                    <Label className='basic-details-label email-footer'>Email Footer:</Label>
                                    <ReactQuill style={{ height: '15%' }} placeholder='Email Footer' />
                                </div>
                            </div>
                            <div className='send-email-field'>
                                <Label className='upload-attachments email-attachments'>Upload Attachments</Label>
                                <div className='dragger-header'>
                                    <Dragger>
