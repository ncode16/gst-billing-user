...
const AddDocumentNotes = ({ documentNotesOpen, toggleDocumentNotes }) => {
                    ...
                    <div style={{ marginTop: '24px' }}>
                        ...
                        <Drawer
                            title={<span className='add-item-heading-main-span'>
                                <span className='add-item-heading-span add-notes-terms-title'>Add/Edit Invoice Notes</span>
                                <span>
            ...
            <div>
                ...
                <div className='footer'>
                    <div style={{ marginTop: '24px' }}>
                        ...
                        <Drawer
                            title={<span className='add-item-heading-main-span'>
                                <span className='add-item-heading-span add-notes-terms-title'>Add/Edit Invoice Terms</span>
                                <span>
                                    <Button color='primary' className='save-update-button'>Save<FontAwesomeIcon icon={faArrowRight} style={{ marginLeft: '5px' }} /></Button>
                                </span>
                            </span>}
            ...
            <div>
                ...
                <div className='footer'>
                    <div style={{ marginTop: '24px' }}>
                        ...
                        <Drawer
                            title={<span className='add-item-heading-main-span'>
                                <span className='add-item-heading-span add-notes-terms-title'>Add/Edit Purchase Notes</span>
                                <span>
                                    <Button color='primary' className='save-update-button'>Save<FontAwesomeIcon icon={faArrowRight} style={{ marginLeft: '5px' }} /></Button>
                                </span>
                            </span>}
            ...
            <div>
                ...
                <div className='footer'>
                    <div style={{ marginTop: '24px' }}>
                        ...
                        <Drawer
                            title={<span className='add-item-heading-main-span'>
                                <span className='add-item-heading-span add-notes-terms-title'>Add/Edit Purchase Terms</span>
                                <span>
                                    <Button color='primary' className='save-update-button'>Save<FontAwesomeIcon icon={faArrowRight} style={{ marginLeft: '5px' }} /></Button>
                                </span>
                            </span>}
            ...
            <div>
                ...
                <div className='footer'>
                    <div style={{ marginTop: '24px' }}>
                        ...
                        <Drawer
                            title={<span className='add-item-heading-main-span'>
                                <span className='add-item-heading-span add-notes-terms-title'>Add/Edit Quotation Notes</span>
                                <span>
                                    <Button color='primary' className='save-update-button'>Save<FontAwesomeIcon icon={faArrowRight} style={{ marginLeft: '5px' }} /></Button>
                                </span>
                            </span>}
            ...
            <div>
                ...
                <div className='footer'>
                    <div style={{ marginTop: '24px' }}>
                        ...
                        <Drawer
                            title={<span className='add-item-heading-main-span'>
                                <span className='add-item-heading-span add-notes-terms-title'>Add/Edit Quotation Terms</span>
                                <span>
                                    <Button color='primary' className='save-update-button'>Save<FontAwesomeIcon icon={faArrowRight} style={{ marginLeft: '5px' }} /></Button>
                                </span>
                            </span>}
            ...
            <div>
                ...
                <div className='footer'>
                    <div style={{ marginTop: '24px' }}>
                        ...
                        <Drawer
                            title={<span className='add-item-heading-main-span'>
                                <span className='add-item-heading-span add-notes-terms-title'>Add/Edit Email Templates</span>
                                <span>
                                    <Button color='primary' className='save-update-button'>Save<FontAwesomeIcon icon={faArrowRight} style={{ marginLeft: '5px' }} /></Button>
                                </span>
                            </span>}
                                ...
                                <div className='basic-details-card-body'>
                                    <Form>
                                        ...
                                        <div className='field-down' style={{ marginTop: '50px' }}>
                                            <Label className='basic-details-label email-editor'>Email Text:</Label>
    ...
    return (
        <Modal
            ...
            className='sidebar-sm document-notes'
