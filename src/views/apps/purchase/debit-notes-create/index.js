...
import { DatePicker, Input, Select, Tooltip, Checkbox, InputNumber, Collapse, Switch, Upload, Dropdown } from 'antd'
...
import { getVendorForDifferentUser } from '../../../../api/vendor/index'
...
const CreatePurchase = () => {
    ...
    const backToList = () => {
        navigate('/apps/debit-notes/list')
    }
    ...
    return (
        <div className='card card-box'>
            <div className='purchase-top-title'>
                <h3 className='create-purchase-header'><ChevronLeft onClick={() => backToList()} />Create Purchase Return / Debit Note
                </h3>
                <div className='pinv-text'>
                    <span><Input type="text" value="PRTN-" className='pinv-text' /></span>
                    <span><Input type="number" value="1" /></span>
                </div>
            </div>
            <div style={{ display: 'flex', marginBottom: '4px' }}>
                <div className='purchase-without-gst' style={{ paddingLeft: '8px' }}>
                    <Checkbox>Create Purchase Return / Debit Note Without GST</Checkbox>
                </div>
                    ...
                    <Row>
                        <Col className='mb-1' xl='4' md='6' sm='12'>
                            <h6 style={{ display: 'flex' }}>
                                ...
                                <button className='add-vendor' type='button' onClick={toggleSidebar}>Add New Vendor?</button>
                            </h6>
                            {/* <Select
                                style={{ width: '100%' }}
                                name="vendor_id"
                            ...
                            <Form.Select>
                                {vendorData && vendorData.map((item) => {
                                    return (
                                        <option>{item?.vendor_name}</option>
                                    )
                                })}
                            </Form.Select>
                            {vendorData && vendorData.map((item) => {
                        ...
                        <Col className='mb-1 vendor-label-main' xl='4' md='6' sm='12'>
                            <div className='vendor-label-box'>
                                <Label className='vendor-label'>
                                    Purchase Return / <br />Debit Note Date
                                </Label>
                                <DatePicker />
                            </div>
                            <div className='vendor-label-box'>
            ...
            <CreateVendor open={sidebarOpen} toggleSidebar={toggleSidebar} />
