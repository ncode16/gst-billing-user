...
const PurchaseList = () => {
    ...
    const handleDebitNote = () => {
        navigate('/apps/debit-notes/create')
    }
    ...
    return (
        <div className='card card-box'>
            <div className='purchase-button'>
                <h3 className='purchase-header'>Purchase Returns / Debit Notes</h3>
                <div className='purchase-header-button'>
                    ...
                    <Button className='ms-2' color='primary' onClick={() => handleDebitNote()}>
                        <Plus size={15} />
                        <span className='align-middle ms-50'>Create Purchase Return / Debit Note</span>
                    </Button>
                </div>
            </div>
            <Fragment>
                                                ...
                                                <div className='action-icon'>
                                                    <UncontrolledDropdown>
                                                        ...
                                                        <DropdownMenu>
                                                            ...
                                                            <DropdownItem href='/' onClick={e => e.preventDefault()}>
                                                                <span className='align-middle' style={{ color: '#e11900' }} onClick={rowModel}><FontAwesomeIcon icon={faCircleMinus} style={{ marginRight: '16px', fontWeight: 400, textAlign: 'center', width: '20px' }} />Cancel Purchase Return / Debit Note</span>
                                                            </DropdownItem>
                                                        </DropdownMenu>
                                                    </UncontrolledDropdown>
                                                </div>
