...
import { faPlusCircle, faInr, faCircleInfo, faArrowRight, faXmark } from '@fortawesome/free-solid-svg-icons'
...
const AddBank = ({ open, toggleSidebar }) => {
    // ** States
    ...
    const text = <span><small>A UPI ID or VPA (Virtual Payment Address) is a unique ID that is used to make UPI payments in place of bank account details.<br />
        This UPI ID will be used to generate <b>Dynamic QR codes</b> on the invoices and bills.</small></span>;
        ...
        <Sidebar
            ...
            title={
                <span className='add-item-heading-main-span'>
                    ...
                    <span>
                        <Button color='primary' className='save-update-button'>Save & Update<FontAwesomeIcon icon={faArrowRight} style={{ marginLeft: '8px' }} color='primary' /></Button>
                    </span>
                </span>
            }
                ...
                <Form onSubmit={handleSubmit(onSubmit)}>
                    <div className='basic-details-card'>
                        <div className='basic-details-card-body'>
                            <div>
                                <Label className='basic-details-label'><em>*</em>Account No</Label>
                                <InputGroup>
                                    <Form.Control
                                        type='number'
                                        name='account_number'
                            ...
                            <div className='field-down'>
                                <Label className='basic-details-label'><em>*</em>Confirm Bank Account No</Label>
                                <InputGroup>
                                    <Form.Control
                                        type='text'
                                        name='account_number'
                            ...
                            <div className='field-down'>
                                <Label className='basic-details-label'><em>*</em>IFSC Code</Label>
                                <div style={{ display: 'flex' }}>
                                    ...
                                    <span className='fetch-bank'>
                                        <Button color='primary' className='bank-details'>Fetch Bank Details</Button>
                                    </span>
                                </div>
                            </div>
                            <div className='field-down'>
                                <Label className='basic-details-label'><em>*</em>Bank Name</Label>
                                <InputGroup>
                                    <Form.Control
                                        type='text'
                                        name='bank_name'
                            ...
                            <div className='field-down'>
                                <Label className='basic-details-label'><em>*</em>Branch Name</Label>
                                <InputGroup>
                                    <Form.Control
                                        type='text'
                                        name='branch_name'
                            ...
                            <div className='field-down'>
                                <Label className='basic-details-label'>
                                    ...
                                    <Tooltip placement="top" title={text}>
                                        <FontAwesomeIcon icon={faCircleInfo} style={{ marginRight: '16px', marginLeft: '4px' }} />
                                    </Tooltip>
                                </Label>
                                <InputGroup>
                                    <Form.Control
                            ...
                            <div className='field-down'>
                                <Label className='basic-details-label'>Opening Balance<span className='optional-badge'>OPTIONAL</span></Label>
                                <InputGroup>
                                    <Form.Control
                                        type='text'
                            ...
                            <div className='field-down'>
                                <Label className='basic-details-label'>UPI Number<span className='optional-badge'>OPTIONAL</span></Label>
                                <InputGroup>
                                    <Form.Control
                                        type='text'
                                        name='upi_number'
                            ...
                            <div className='field-down'>
                                ...
                                <div className='form-switch form-check-primary'>
                                    <Input type='switch' id='switch-primary' name='primary' {...register('default')} />
                                </div>
                                <div className='default-bank'>This will override you previous default bank</div>
                            </div>
                        </div>
                    </div>
