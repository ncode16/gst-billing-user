...
const List = () => {
  ...
  const createPurchase = () => {
    navigate("/apps/quotations/preforma-invoices/create");
  };
    ...
    <div className="quotation-tabs card">
      <div className="quotation-top-bar">
        <div className="quotation-heading">
          <h3>
            Pro Forma Invoices
            <span className="playcircle-icon">
              <Play />
            </span>
          </h3>
        </div>
        <div className="settings-create-btns">
          <button className="document-btn" onClick={toggleSidebar}>
            <span className="settings-icon">
              <Settings />
            </span>
            Document Settings
          </button>
          <button className="create-btn btn-primary" onClick={createPurchase}>
            ...
            <div className="tabs-content-holder">
              <div className="tabs-search-calendar">
                ...
                <div className="col-lg-3 tabs-calendar">
                  ...
                  <div className="picker-range-separato">
                    <ArrowRight />
                  </div>
            ...
            <Table responsive>
              <thead>
                <tr>
                          ...
                          <div className="dropdown-input">
                            <div className="dropdown-select-all-items">
                              <Input
                                ...
                                type="checkbox"
                              />
                              <label className="label">Select all items</label>
                            </div>
                  ...
                  <th>
                    <span>
                      <span class="font-size-12 mt-0 mb-0">Date / </span>
                      <span class="font-size-10 mb-0 mt-0">Updated Time</span>
                    </span>
                  </th>
