            ...
            {state && (
                    ...
                    <div  className="tworow home-tworow">
                        ...
                        <div className="secondrow">
                            <img className="imgborder" src="https://raw.githubusercontent.com/ncode16/gst-billing-backend/master/public/template/image-1680162824251.webp" width={'500px'} alt="img2" />
                        </div>
                    </div>
            )}
        </div>
